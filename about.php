            ...
            <ul>
                <?php
                    if(isset($_SESSION['id'])) {
                        echo '<li id = "one"><a href = "welcome.php">Home</a></li>';
                    } else {
                ...
                <?php
                    if(isset($_SESSION['id'])) {
                        echo '<li id = "two" class = "current"><a href = "about.php">About</a></li>';
                    } else {
                ...
                <?php
                    if(isset($_SESSION['id'])){
                        ...
                        ';
                        echo '<li id = "down"><a id = "black" href = "includes/logout.inc.php"><i>Log out</i></a></li>
